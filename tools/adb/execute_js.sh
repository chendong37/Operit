...
resolve_app_package() {
    # The applicationId scopes the external directory and broadcast action, while the
    # receiver class keeps the Kotlin namespace used by the Android source tree.
