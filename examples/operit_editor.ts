...
function get_host_application_id(): string {
...
const MCP_CONFIG_DIR = String(
  APP_PATHS.writableMcpPluginsDir(Java.getApplicationContext()).getAbsolutePath()
);
...
const TOOLPKG_DEBUG_INSTALL_COMPONENT =
  `${HOST_APPLICATION_ID}/com.ai.assistance.operit.core.tools.packTool.ToolPkgDebugInstallReceiver`;
const SANDBOX_SCRIPT_EXECUTION_ACTION = `${HOST_APPLICATION_ID}.EXECUTE_JS`;
const SANDBOX_SCRIPT_EXECUTION_COMPONENT =
  `${HOST_APPLICATION_ID}/com.ai.assistance.operit.core.tools.javascript.ScriptExecutionReceiver`;
